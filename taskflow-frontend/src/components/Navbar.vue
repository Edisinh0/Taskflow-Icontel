<template>
  <nav class="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-md border-b border-white/5 transition-all">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16">
        <!-- Logo y nombre -->
        <div class="flex items-center space-x-8">
          <router-link to="/dashboard" class="flex items-center space-x-3 group">
            <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-900/20 group-hover:scale-105 transition-transform">
              <span class="text-white font-extrabold text-xl tracking-tighter">TF</span>
            </div>
            <span class="text-xl font-bold text-white tracking-tight group-hover:text-blue-400 transition-colors">
              TaskFlow
            </span>
          </router-link>
        ...
        <div class="hidden md:flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-3 group cursor-pointer">
             <div class="hidden sm:block text-right">
              <p class="text-sm font-bold text-white group-hover:text-blue-400 transition-colors">
            ...
            <div class="w-10 h-10 rounded-full bg-slate-700/50 border border-white/10 flex items-center justify-center text-white font-bold text-sm shadow-inner group-hover:bg-blue-600 group-hover:text-white transition-all">
          ...
          <button
            @click="handleLogout"
            class="p-2 text-slate-500 hover:text-white hover:bg-white/5 rounded-lg transition-all"
            title="Cerrar sesión"
          >
